        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20">
            ...
            <div class="lg:col-span-5 flex flex-col">
                ...
                <div class="flex items-center gap-4 mb-8">
                    ...
                    {{-- <span class="px-2 py-0.5 bg-[#fdf2f2] text-[#d97771] text-[10px] tracking-wider uppercase">Save {{ number_format($variant->selling_price ?? 0) }} - {{ number_format($variant->base_price ?? 0) }} VNĐ </span> --}}
                </div>
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex gap-4">
                        <div class="relative w-24">
                            <select x-model="quantity" class="w-full border py-4 px-3 appearance-none cursor-pointer">
                        ...
                        <form action="{{route('cart.add') }}" method="POST" class="flex items-center gap-4">
                            ...
                            <button
                                ...
                                class="flex-1 bg-black text-white uppercase px-8 py-4 text-lg font-semibold hover:bg-gray-800 transition duration-300">
                                Add to Cart
                            </button>
                        </form>
                    </div>
