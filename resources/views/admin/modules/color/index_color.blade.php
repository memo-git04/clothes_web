        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Bảng màu sắc </h4>
                            ...
                            <div class="add mt-2 mx-4">
                                <a href="{{ route('admin.colors.create') }}"><button type="button" class="btn btn-success"><i class="fa-solid fa-plus"></i> Thêm màu mới</button></a>
                            </div>
                        </div>
